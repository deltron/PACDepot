					...
					<font color="#FF0000"><b>
						<xsl:choose>
							...
							<xsl:when test="/page/@state = 'success'">
								Mise-à-jour effectuée avec succès. Un préposé fera une validation d'éthique et rendra publique votre annonce dans les heures qui suivent.
							</xsl:when>
						</xsl:choose>
					</b></font>	
					...
					<form method="post" action="/{/page/@section}/previewItem" enctype="multipart/form-data">
						<xsl:call-template name="subsection">
							...
							<xsl:with-param name="body">
								...
								<b>Titre</b><br/>
								Donnez un titre à votre annonce (maximum 60 caractères)<br/>
								...
								<b>Description</b><br/>
								Description détaillée de votre annonce.  Il vous est possible d'utiliser quelques commande HTML de base pour rendre votre annonce intéressante (maximum 1000 caractères)<br/>
						...
						<xsl:call-template name="subsection">
							...
							<xsl:with-param name="body">
								...
								<b>Nom et prénom de la personne</b><br/>
								(maximum 40 charactères)<br/>
								...
								<b>Téléphone</b><br/>
								Exemple: (999) 999-9999 poste 999<br/>
						...
						<xsl:call-template name="subsection">
							<xsl:with-param name="title">
								Ajouter un image à votre annonce (Taille maximum de 128KB)
							</xsl:with-param>
							<xsl:with-param name="body">
								<xsl:choose>
									<xsl:when test="errors/photo">
						...
						<xsl:call-template name="subsection">
							<xsl:with-param name="title">
								Identifier dans quelle catégorie votre annonce doit apparaître
							</xsl:with-param>
							<xsl:with-param name="body">
						...
						<xsl:call-template name="subsection">
							<xsl:with-param name="title">
								Quelle est la ville la plus près de chez-vous
							</xsl:with-param>
							<xsl:with-param name="body">
								<xsl:if test="errors/cityid">
									<font color="#FF0000" size="+2"><b>*</b></font>
								</xsl:if>
								Le lieu suivant sera utilisé pour localiser géographiquement votre annonce. NOTE : Ceci n'empêchera pas les gens des autres localités de voir votre annonce. Elle pourra être vue par TOUT le monde, peu importe le lieu que vous avez choisi. <br/>
