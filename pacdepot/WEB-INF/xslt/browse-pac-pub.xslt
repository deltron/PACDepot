...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <table align="center" border="0" width="90%"  cellspacing="4">
      <tr>
		<td> 
                            ...
                            <tr>
                                 <td width="10%">       
                                              <table border="0" >
                                                     <tr>
                                                          <td>
                                                               <img src="/images/logo-pub.gif"/></td>
			...
			<font size="+2" color="red" ><b><xsl:value-of select="item/@title"/></b></font>
				...
				<tr>
					<td >
                                          ...
                                          <p align="left">   <i> Publié par: <xsl:value-of select="item/user/@name"/></i></p>
                                      
                                           <p align="left"><i>   Courriel: <a href="mailto:{item/user/@email}?subject={item/@title} (#{item/@id})">
